...
class GradesControllerTest < ActionController::TestCase
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post :create, grade: { disc: @grade.disc, exam: @grade.exam, lab: @grade.lab, name: @grade.name, nick: @grade.nick, num: @grade.num, pro: @grade.pro }
    end
  ...
  test "should update grade" do
    put :update, id: @grade, grade: { disc: @grade.disc, exam: @grade.exam, lab: @grade.lab, name: @grade.name, nick: @grade.nick, num: @grade.num, pro: @grade.pro }
    assert_redirected_to grade_path(assigns(:grade))
  end
